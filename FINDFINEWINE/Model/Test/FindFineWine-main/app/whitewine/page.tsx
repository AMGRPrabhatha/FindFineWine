    ...
    return (
        <div className='w-full max-w-7xl flex flex-col mx-auto font-basker'>
            <div>
                ...
                <Heading 
                    heading ="White Wines" 
                    subheading = "White wine is a refreshing and versatile beverage, known for its light, crisp flavors and aromas, often featuring notes of citrus, apple, pear, and tropical fruits. Perfect for any occasion."
                />
            </div>
