...
export default function Navbar() {
  ...
  return (
    <div className="mx-auto flex  w-full max-w-7xl justify-between px-4 py-5 text-sm border-b-2">
      {/* left side  */}
      {/* <section ref={animationParent} className="flex items-center gap-10"> */}
        {/* logo */}
      
        <div className="flex  items-center">
        <Link className="text-black font-semibold text-2xl items-center " href= "./">
          FindFine
        ...
        <div className="hidden md:flex items-center gap-4 transition-all font-basker text-lg">
          {navItems.map((d, i) => (
            <div key={i} className="relative group px-2 py-3 transition-all">
            <Link href={d.link ?? "#"}>
                <p className="flex cursor-pointer items-center gap-2 text-neutral-800 group-hover:text-[#cca3ee]">
                    <span>{d.label}</span>
                    {d.children && (
